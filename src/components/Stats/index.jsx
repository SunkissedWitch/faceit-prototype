  ...
  return (
    <div className="stats stats-vertical sm:grid-cols-2 lg:grid-cols-none lg:stats-horizontal sm:gap-y-8 w-full">
      {staticStat.map((stat, index) => (
        <div key={`${stat.value}-${index}`} className="stat py-6 pt-2 lg:py-0.5 custom-medium-stats first:before:hidden before:bg-neutral dark:before:bg-base-300 border-transparent lg:before:hidden lg:border-neutral dark:lg:border-[#252525] sm:before:hidden lg:after:hidden odd:after:hidden after:hidden sm:after:block">
